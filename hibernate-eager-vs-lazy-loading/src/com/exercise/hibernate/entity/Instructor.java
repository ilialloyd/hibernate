...
public class Instructor {
    ...
    @ToString.Exclude
    @OneToMany(//fetch = FetchType.EAGER,   //in this case, when we get insturctor, it will give us courses as well
            fetch = FetchType.LAZY,    //courses will load only on demand
               mappedBy = "instructor",        //instructor from Course class
